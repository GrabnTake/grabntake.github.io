---
title: "Automating Ubuntu CIS audit checks"
date: '2026-04-03T21:11:31+01:00'
description: Ubuntu 24.04 CIS Benchmark Audit Script.
draft: true
...
```bash
git clone https://github.com/GrabnTake/CIS_Ubuntu_audit.git
cd CIS_Ubuntu_audit
sudo ./Ubuntu.sh
```
## 📦 Output
